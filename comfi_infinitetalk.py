...
def download_models():
    ...
    lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16 = hf_hub_download(repo_id="Kijai/WanVideo_comfy", filename="Lightx2v/lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16.safetensors", cache_dir="/cache")
    subprocess.run(f"ln -s {lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16} /root/comfy/ComfyUI/models/loras/lightx2v_I2V_14B_480p_cfg_step_distill_rank256_bf16.safetensors", shell=True, check=True)
...
def main():
    ...
    video_datetime = datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
    output_path = Path(f"/Users/firozahmed/Downloads/video_{video_datetime}.mp4")
