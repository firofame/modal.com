...
class ComfyUI:
    ...
    def infer(self, workflow_path: str = "/root/workflow_api.json"):
        ...
        file_prefix = "WanVideo2_1_InfiniteTalk"
        output_dir = Path("/root/comfy/ComfyUI/output")
        valid_exts = {".mp4", ".webm", ".gif", ".png", ".jpg", ".jpeg"}

        candidates = [
            p for p in output_dir.rglob(f"{file_prefix}*")
        ...
        if not candidates:
            ...
            raise FileNotFoundError(
                "No output file found. Make sure VHS_VideoCombine.save_output=true and "
                f"that files are written to {output_dir}/videos."
            )
...
def main():
    ...
    output_path = Path("/Users/firozahmed/Downloads/comfy_output.mp4")
